...
function Modif() {
    ...
    const currentItems = modifData.slice(indexOfFirstItem, indexOfLastItem);
            ...
            <div className="main-content">
                ...
                <div className="content">
                    ...
                    <div className="padding-top-black">
                        <h2 className="text-center">Ajouter Modif</h2>
                    </div>
                    <div className="table-wrapper">
                        <div className="row">
                            <div className="col-md-6">
                                <div className="form-container">
                                    <h2>Ajouter une Modif</h2>
                                    <form onSubmit={ajouterModif}>
                                        <div className="mb-3">
                                            <label className="form-label">Nom Modif:</label>
                                            <input
                                                type="text"
                                                className="form-control"
                                                placeholder="Insérer nom Modif"
                                                value={data}
                                    ...
                                    <table className="table table-striped table-hover table-bordered">
                                        ...
                                        <tbody>
                                            {Array.isArray(currentItems) && currentItems.length > 0 ? (
                                                currentItems.map(modif => (
                                                    <tr key={modif.id_modif}>
                                                        <td>{modif.nom}</td>
                                                    </tr>
                                                ))
                                            ) : (
